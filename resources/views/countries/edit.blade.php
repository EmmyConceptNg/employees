    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <a href="{{ route('countries.index') }}" class="float-right">Back</a></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('countries.update', $country->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="country_code" type="text" class="form-control @error('name') is-invalid @enderror" name="country_code" value="{{ old('country_code', $country->country_code) }}" required autocomplete="country_code" autofocus>
