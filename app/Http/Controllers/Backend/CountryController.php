...
class CountryController extends Controller
{
    ...
    public function update(UpdateCountryRequest $request, Country $country)
    {
        ...
        return redirect()->route('countries.index')->with('message', 'County Updated Successfully');
    }
    ...
    {
        $country->delete();
        return redirect()->route('countries.index')->with('message', 'County Deleted Successfully');
    }
}
